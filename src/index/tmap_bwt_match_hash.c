...
#if TMAP_BWT_INT_MAX == 0xffffu
TMAP_HASH_MAP_INIT_INT(tmap_bwt_match_hash, tmap_bwt_int_t) 
#else 
TMAP_HASH_MAP_INIT_INT64(tmap_bwt_match_hash, tmap_bwt_int_t) 
#endif
...
tmap_bwt_match_hash_get(tmap_bwt_match_hash_t *h, tmap_bwt_int_t key, uint8_t c, uint32_t *found)
{
  ...
  if(tmap_hash_end(hash) == iter) { // not found
      ...
      *found = 1;
      // return the value
      return (tmap_bwt_int_t)(tmap_hash_val(hash, iter));
  }
}

// NB: assumes we pass in prev_k, not prev_k-1, and that val had 'L2[c] + 1' added
static inline int32_t
tmap_bwt_match_hash_put_k(tmap_bwt_match_hash_t *h, tmap_bwt_int_t k, uint8_t c, tmap_bwt_int_t val)
{
...
static inline int32_t
tmap_bwt_match_hash_put_l(tmap_bwt_match_hash_t *h, tmap_bwt_int_t l, uint8_t c, tmap_bwt_int_t val)
{
...
tmap_bwt_match_hash_get_k(tmap_bwt_match_hash_t *h, tmap_bwt_int_t k, uint8_t c, uint32_t *found)
{
...
static inline tmap_bwt_int_t
tmap_bwt_match_hash_get_l(tmap_bwt_match_hash_t *h, tmap_bwt_int_t l, uint8_t c, uint32_t *found)
{
