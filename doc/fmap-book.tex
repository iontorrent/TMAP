...
Specifying TMAP without a command will give a list of commands, while specifying FMAP with a command but no options will give a list of options for that command.
...
An example would be:\\
\TT{tmap mapall -f ref.fasta -r reads.fastq -g -M 3 map1 -l 12 -k 24 MAP2 -b 5 MAP3 -S 10}.\\
