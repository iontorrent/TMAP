...
This algorithm performs the full Smith Waterman algorithm alignment of the read to the reference genome, using SSE4.1 (vectorized) programming instructions.
