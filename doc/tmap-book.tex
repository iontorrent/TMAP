...
\subsubsection{\TT{-H INT}}
Specifies the number of bases to enumerate for a single homopolymer within the seed.

\subsubsection{\TT{-V FLOAT}}
Specifies the fraction of seed positions that are under the maximum (\TT{-S}).
\section{tmap mapvsw}
\label{sec:mapvsw}
