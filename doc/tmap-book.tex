...
\section{Insertion/Deletion Justification}
TMAP will attempt to justify insertions and deletions (indel) to the 5' (left-most) end of the genomic (reference) forward strand.
This allows the indel to be consistently placed with respect the reference, regardless of the strand during sequencing
Neither the query nor the reference sequence are changed, only the indel position in the alignment.
